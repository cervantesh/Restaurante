...
namespace ProyectoRestaurante.Controllers
{
    public class DireccionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DireccionID,Calle,Numero,Ciudad,Pais,FKSucursalID")] Direccion direccion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DireccionID,Calle,Numero,Ciudad,Pais,FKSucursalID")] Direccion direccion)
        {
            if (ModelState.IsValid)
            {
